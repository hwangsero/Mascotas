...
public class Com_FreeShareRegFormController implements Controller {
	...
	public String handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		dao.insertFreeShareBoard(board);
		...
		//2.첨부파일 저장(board_file)
	 	...
	 	return "/menu/com_FreeShare/com_FreeShareList.do?pageNo=1";
