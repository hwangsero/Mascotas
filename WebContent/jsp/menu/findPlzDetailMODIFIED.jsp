...
<head>
    ...
    <link href="C:\Lecture\web-workspace\petSite\WebContent\vendor\bootstrap\css\bootstrap.min.css" rel="stylesheet">
    Bootstrap core CSS
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-9" style="margin-left: 150px;">
          ...
          <div class="card mt-4">
          <div class="bxslider">
            <img class="card-img-top img-fluid" src="../../images/Penguins.jpg" alt="">
...
<!-- 	              <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sapiente dicta fugit fugiat hic aliquam itaque facere, soluta. Totam id dolores, sint aperiam sequi pariatur praesentium animi perspiciatis molestias iure, ducimus!</p> -->
              ...
              <hr>
              <h4>특징</h4>
	              <p class="card-text">${findPlz.feature }</p>
              <hr>
              <h4>연락처</h4>
	              <table class="table">
	              	<tr>
	              		<th>글쓴이</th>
	              		<td>${findPlz.writer }</td>
	              	</tr>
	              	<tr>
	              		<th>전화번호</th>
	              		<td>${findPlz.tel }</td>
