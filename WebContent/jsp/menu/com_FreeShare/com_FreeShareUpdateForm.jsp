...
<body>
	...
	<div align="center">
	<form method="post" action="<%=request.getContextPath()%>/menu/com_FreeShare/com_FreeShareUpdateProcess.do?no=<%=request.getParameter("no")%>" name="wForm"
			enctype="multipart/form-data" onsubmit="return checkForm()">
			<input type="hidden" value="입양게시판" name="cate">
			...
			<tr>
				<th>분류</th>
				<td>
				<c:if test="${board.com_cate eq '나눔합니다' }">
					<select name="com_cate" class="form-control" style="width:120px;">
						<option selected="selected">나눔합니다</option>
					</select>
				</c:if>
