...
<script>
	function doAction(type) {
		...
		case 'L' : 
			...
			break;
		case 'U' :
			location.href = "<%= request.getContextPath() %>/menu/com_FreeShare/com_FreeShareUpdate.do?no=${param.no}";
			break; 
		case 'D' : 
			if(confirm("삭제하시겠습니까?")){
				location.href="<%= request.getContextPath() %>/menu/com_FreeShare/com_FreeShareDelete.do?no=${param.no}";
			}
			break;
		}
	}
