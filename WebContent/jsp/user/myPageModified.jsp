	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-8 order-md-1">
				...
				<form method="post" action="<%=request.getContextPath() %>/menu/myPageModified.do" class="needs-validation" onsubmit="return passwordCheck()">
					<input type="hidden" name="id" value=${userVO.id }>
					<input type="hidden" name="type" value=${userVO.type }>
					<div class="row">
						<div class="col-md-6 mb-3">
							<label for="firstName">아이디</label> 
							<input type="text" class="form-control" id="firstName" value="${userVO.id }" name="id" disabled>
						</div>
					</div>
					...
					<div class="mb-3">
						...
						<div class="input-group">
							<input type="text" class="form-control" id="username" value="${userVO.name }" name="name">
						</div>
					</div>
					<div class="mb-3">
					...
					<div class="mb-3">
						...
						<div class="input-group">
							<input type="password" class="form-control" id="passcheck" placeholder="비밀번호를 다시 입력하세요" >
						</div>
					</div>
                  ...
                  <div class="input-group">
                  <input type="text" class="form-control" id="email1" value="${userVO.email_id }" name="email_id" size="16" style="width: 25%;position: relative;"><div class="input-group-text" style="width: 40px;position: relavtive;">@</div><input type="text" class="form-control" id="email2" value="${userVO.email_domain }" name="email_domain" size="16" style="width: 40%;position: relative;">
                  </div>
               </div>
					...
					<div class="mb-3">
						...
						<input type="text" class="form-control" id="address1" value="${userVO.basic_addr }" name="basic_addr">
					</div>
					<div class="mb-3">
						<label for="detail_addr">상세주소</label> 
						<input type="text" class="form-control" id="address2" value="${userVO.detail_addr }" name="detail_addr" >
					</div>
